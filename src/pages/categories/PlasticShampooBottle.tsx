...
import heroImage from "@/assets/primary-packaging/plastic-shampoo-bottle-hero.webp";
    ...
    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 xl:gap-16 items-start">
                        <div className="space-y-6 text-center lg:text-left">
                            ...
                            <p className="text-[16px] text-muted-foreground leading-relaxed line-clamp-4 px-4 lg:px-0">
                                Discover our durable plastic shampoo bottles.
                                Designed for hair care products, they offer robustness and a sleek look for your brand.
                            </p>
                ...
                <div className="container mx-auto px-4">
                    <div className="mb-12 text-center">
                        ...
                        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                            Browse our selection of packaging to complement your plastic shampoo bottles.
                        </p>
                    </div>
            ...
            <SEOContent>
                ...
                <h2>The Ultimate Guide to Plastic Shampoo Bottle</h2>
                <p>
                    Elevate your brand presence with our premium <strong>Plastic Shampoo Bottle</strong>.
                ...
                <p>
                    We believe that quality starts with the right materials. Our Plastic Shampoo Bottle are manufactured using top-tier stocks selected for their durability and finish.
