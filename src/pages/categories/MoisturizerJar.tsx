...
import heroImage from "@/assets/primary-packaging/moisturizer-jar-hero.webp";
    ...
    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
                ...
                <div className="container mx-auto px-4">
                    <div className="mb-12 text-center">
                        ...
                        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                            Discover more jars and bottles for your comprehensive skincare range.
                        </p>
                    </div>
            ...
            <SEOContent>
                ...
                <h2>The Ultimate Guide to Moisturizer Jar</h2>
                <p>
                    Elevate your brand presence with our premium <strong>Moisturizer Jar</strong>.
                ...
                <p>
                    We believe that quality starts with the right materials. Our Moisturizer Jar are manufactured using top-tier stocks selected for their durability and finish.
