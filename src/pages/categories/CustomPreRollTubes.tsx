...
import heroImage from "@/assets/primary-packaging/custom-pre-roll-tubes-hero.png";
                        ...
                        <div className="space-y-6 text-center lg:text-left">
                            ...
                            <div className="pt-4 flex justify-center lg:justify-start">
                                <div className="relative w-full max-w-[480px] h-[300px] overflow-hidden rounded-lg shadow-lg bg-muted flex items-center justify-center">
                                    <img src={heroImage} alt="Custom Pre Roll Tubes" className="w-full h-full object-cover" />
                                </div>
                            </div>
                        </div>
