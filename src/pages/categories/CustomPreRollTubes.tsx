...
import heroImage from "@/assets/primary-packaging/custom-pre-roll-tubes-hero.webp";
    ...
    return (
        <div className="min-h-screen bg-background w-full max-w-[100vw] overflow-x-hidden">
                ...
                <div className="container mx-auto px-4 py-4">
                    <Breadcrumb>
                        <BreadcrumbList>
                            ...
                            <BreadcrumbSeparator />
                            <BreadcrumbItem>
                                <BreadcrumbPage>Custom Pre Roll Tubes</BreadcrumbPage>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 xl:gap-16 items-start">
                        <div className="space-y-6 text-center lg:text-left">
                            ...
                            <p className="text-[16px] text-muted-foreground leading-relaxed line-clamp-4 px-4 lg:px-0">
                                Secure and brand your pre-rolls with our custom pre-roll tubes.
                                Designed for freshness and convenience, they are perfect for your cannabis products.
                            </p>
                            <div className="pt-4 flex justify-center lg:justify-start">
                                <div className="relative w-full max-w-[480px] h-[300px] overflow-hidden rounded-lg shadow-lg bg-muted flex items-center justify-center">
                                    <img src={heroImage} alt="Custom Pre Roll Tubes" className="w-full h-full object-cover" loading="lazy" />
                                </div>
                            </div>
                        </div>
                ...
                <div className="container mx-auto px-4">
                    <div className="mb-12 text-center">
                        ...
                        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                            Check out other related packaging for cannabis and retail products.
                        </p>
                    </div>
            ...
            <SEOContent>
                ...
                <h2>The Ultimate Guide to Custom Pre Roll Tubes</h2>
                <p>
                    Elevate your brand presence with our premium <strong>Custom Pre Roll Tubes</strong>.
                ...
                <p>
                    We believe that quality starts with the right materials. Our Custom Pre Roll Tubes are manufactured using top-tier stocks selected for their durability and finish.
...
export default CustomPreRollTubes;
