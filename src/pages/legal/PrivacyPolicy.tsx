...
const PrivacyPolicy = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 w-full font-sans text-gray-900">
            ...
            {/* Main Content Container - Padded top to clear fixed header */}
            <main className="pt-32 pb-24 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
                ...
                {/* Content */}
                <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed prose-headings:font-bold prose-headings:text-gray-900 prose-a:text-primary hover:prose-a:text-primary/80 transition-colors">
